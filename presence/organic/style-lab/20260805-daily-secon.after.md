...
- **[GOV-RedTS]** Recopilar en carpeta compartida la información útil para ese análisis (documentos originales, RCAs, insumos de HM y SAS) — acuerdo de cierre del Meet del 08-04.
- **[SAS/HM · S/T]** ⭐ Iniciar redacción de documento de alcance (restricciones y requerimientos) para SAS y HM — deadline martes 2026-08-11 para el primer eslabón de la cadena de entregables.
...
- **[GOV-RedTS]** Reflejar en el tablero de status de RCA/OT la reversión de la Directriz Arquitectónica del 29/07: las OTs de SAS se consolidan en una sola, no por tipo, confirmado por Josué.
