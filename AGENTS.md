...
7c. **Título de ventana (2026-09-10, regla de Lalo):** poner el nombre en el título de la terminal con `~/kz/scripts/kz-titulo.sh` siempre que el sistema lo permita.
